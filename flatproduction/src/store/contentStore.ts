...
const DEFAULT_SITE_CONTENT: SiteContent = {
  ...
  portfolio: [
    { id: 'pf-1', title: 'Photography',    image: '/photo1.jpg',         link: '#', description: 'We capture stunning visuals that tell your unique story with precision and artistic flair.' },
    { id: 'pf-2', title: 'Video Production', image: '/2I1A0386.JPG.jpeg', link: '#', videoUrl: 'https://youtu.be/RjXqY31jpy0', btsUrl: 'https://youtu.be/DHR85WBk4tY', description: 'We deliver high-end video production services tailored for commercials, events, and cinematic projects.' },
    { id: 'pf-3', title: 'Live Streaming', image: '/2I1A0403.JPG.jpeg',  link: '#', videoUrl: 'https://youtu.be/de6oWk6vGlM', btsUrl: 'https://youtu.be/zWTFpxzQaes', description: 'We provide professional multi-camera live streaming solutions to connect you with a global audience instantly.' },
    { id: 'pf-4', title: 'Web & Digital',  image: '/web.jpg',            link: '#', description: 'We offer comprehensive digital strategies including web design, development, and online marketing solutions.' },
    { id: 'pf-5', title: 'Branding',       image: '/graphy33.jpg',       link: '#', description: 'We create memorable brand identities that resonate deeply with your target market and stand out.' },
    { id: 'pf-6', title: 'Documentary',    image: '/photo12.jpg',        link: '#', description: 'We specialize in in-depth documentary filmmaking that brings important real-world stories to light.' },
  ],
